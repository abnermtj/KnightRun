...
module volumebar2(
    ...
    input[3:0] volumelevel
     ...
     parameter BORDER = 16'b0000111111111111, TOP = 16'b0010101011111111,
                 MID = 16'b0111000101101111, LOW =16'b1111111111111111,
                 BACK = 16'b1001111111000111;
    always @(*) begin 
        ...
        if (volumebarmode == 1) begin
         if (bordermode == 1 &&(x == 0 || x == 95 || y == 0 || y == 63) )begin
             ...
             oled = BACK; // black this collides with border
         end                            
       end
